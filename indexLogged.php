            ...
            <div class="landing-page">
                ...
                <nav>
                    <div class="navbar">
                        ...
                        <ul class="navigation">
                            ...
                            <li> <a href="logout.php" class="nav-link"> Wyloguj się wip</a> </li>
                            <li> <a href="indexLogged.php" class="nav-link active"> Panel</a> </li>
                        </ul>
                ...
                <div class="headline-car">
                    <div class="headline-section">
                        <h1 class="headline">Zalogowało cie, witam w panelu</h1>
                        <p class="sub-headline">eś</p>
                        <a href="#section-0" class="btn-more" title="Dowiedz się wiecęj o naszym serwerze">Więcej</a>
                    </div>
                </div>

                    ...
                    <div class="job-container">
                        <section>
                            <a href="requestQuiz.php?job=medic">
                                <div class="job"><div class="job-logo"><img src="../assets/mediclogo.png"> <h1>medyk</h1> <p>Wciel się w rolę medyka, wykonuj wymagające operacje i pomagaj potrzebującym</p></div><div class="layer-job"></div><img src="../assets/medic.jpg"></div>
                            </a>
                        </section>
                        <section>
                            <a href="requestQuiz.php?job=police">
                                <div class="job"><div class="job-logo"><img src="../assets/policelogo.png"> <h1>policjant</h1> <p>Zostań policjantem i przypilnuj, by w mieście panował porządek. </p></div><div class="layer-job"></div><img src="../assets/police.jpg"></div>
                            </a>
                        </section>
                        <section>
                            <a href="requestQuiz.php?job=mechanic">
                                <div class="job"><div class="job-logo"><img src="../assets/mechaniclogo.png"> <h1>mechanik</h1> <p>Pracuj jako mechanik, tuninguj fury bogaczom i naprawiaj fury biedakom. </p></div><div class="layer-job"></div><img src="../assets/mechanic.png"></div>
                            </a>
                        </section>
                    </div>
                </article>
